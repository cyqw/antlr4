...
//		System.out.println("otherAlt " + alt + ": " + altText);
	 ...
	 */
	public static boolean hasImmediateRecursiveRuleRefs(ANTLRParser.ParserRuleSpecContext t, String ruleName) {
		if ( t==null ) return false;
		ANTLRParser.RuleBlockContext blk = t.ruleBlock();
		if ( blk==null ) return false;
		Tree matchRuleRef = Trees.findNodeSuchThat(blk, it ->
				TerminalNode.class.isInstance(it) && ((TerminalNode) it).getText().equals(ruleName));
		return matchRuleRef != null;
	}
